...
const goToCatalog = () => {
  router.push(`/registration/${productId}`);
};
    ...
    <div v-if="product" class="flex flex-col gap-[40px]">
      ...
      <div class="md:flex hidden items-center gap-[18px]">
        ...
        <Icon
          ...
          :style="{ color: '#9DA1AA' }"
        />
        <p class="text-[16px] text-black01 font-normal font-sans">
          Конструктор
        </p>
      </div>

      <div
        class="flex flex-col lg:flex-row justify-between gap-[32px] items-center"
      >
        <!-- left -->
        <div
          class="flex flex-col-reverse items-center justify-center gap-[40px]"
        >
          <!-- img -->
          <div class="flex sm:flex-row flex-col-reverse gap-[24px]">
            <div
              class="sm:w-[472px] sm:h-[472px] w-[342px] h-[342px] bg-gray01/15 rounded-[8px]"
            >
              <img
                :src="selectedImage"
          ...
          <div class="flex flex-col gap-[32px]">
            <div class="flex flex-col gap-[24px]">
              <div class="flex flex-col gap-[10px]">
                <span class="text-[18px] text-gray01 font-medium"
                  >Артикул: 1234567890</span
                >
                <h1 class="text-[34px] text-black01 font-semibold">
                  {{ product.name }}
                </h1>
              </div>
              <div class="flex items-center justify-between">
                <div class="flex flex-col">
                  <h2 class="text-[26px] font-semibold text-orange01">
                    {{ product.price }}
                  </h2>
                ...
                >
                  <img
                    ...
                    :src="
                      hoveredIcon3
                        ? '/images/home/catalog/icon3Hover.svg'
                        : '/images/home/catalog/icon3.svg'
                    "
                    alt="profIcon"
                  />
                </div>
        ...
        <!-- right -->
        <div
          class="lg:w-1/2 w-full grid lg:grid-cols-1 md:grid-cols-2 gap-[16px]"
        >
          <!-- 1 -->
          <div
            @click="toggleStela"
            class="flex items-center justify-between w-full border py-[16px] px-[24px] rounded-[8px] cursor-pointer"
          >
            <div class="flex flex-col gap-[6px]">
              <p class="text-[18px] text-gray01 font-normal">Стела</p>
              <h2 class="text-[20px] text-black01 font-semibold">
                Размер 80*40*8 см
              </h2>
            </div>
            <div
              :class="[
                ...
                isOpenStela ? '-rotate-180' : 'rotate-0',
              ]"
            >
              <Icon
          ...
          <div
            v-if="isOpenStela"
            class="w-full border rounded-b-[8px] border-t-0 px-[34px] pb-[16px]"
          >
            <p class="text-[18px] text-gray01 font-medium">Выберите размер</p>
            <div class="flex gap-[8px] mt-[8px]">
              <div
                class="bg-orange01/[6%] hover:bg-orange01/10 transition-colors duration-300 cursor-pointer rounded-[8px] py-[12px] px-[16px]"
              >
                <span class="text-[18px] text-black01 font-semibold"
                  >80*40*8 см</span
                >
              </div>
              <div
            ...
            <p class="text-gray-500 mt-[8px] text-[14px] leading-[1.4]">
              * При выборе размеров, параметры стелы расчитываются как
              <br />высота * ширина * толщина
            </p>
          </div>
          ...
          >
            ...
            <div
              :class="[
                'transition-transform duration-300',
                isOpenPost ? '-rotate-180' : 'rotate-0',
              ]"
            >
              <Icon
                icon="meteor-icons:chevron-down"
          ...
          <div
            v-if="isOpenPost"
            class="w-full border border-t-0 rounded-b-[8px] px-[34px] pb-[16px]"
          >
            <p class="text-[18px] text-gray01 font-medium">Выберите размер</p>
            <div class="flex gap-[8px] mt-[8px]">
              <div
            ...
            <p class="text-gray-500 mt-[8px] text-[14px] leading-[1.4]">
              * При выборе размеров, параметры постамента расчитываются как
              <br />высота * ширина * толщина
            </p>
          </div>
          ...
          >
            <div class="flex flex-col gap-[6px]">
              <p class="text-[18px] text-gray01 font-normal">
                Цветник / Надгробная плита
              </p>
              <h2 class="text-[20px] text-black01 font-semibold">
                Цветник: 80*50/8*8 см
              </h2>
            </div>
            <div
              :class="[
                'transition-transform duration-300',
                isOpenPlit ? '-rotate-180' : 'rotate-0',
              ]"
            >
              <Icon
                icon="meteor-icons:chevron-down"
          ...
          >
            ...
            <p class="text-gray-500 mt-[8px] text-[14px] leading-[1.4]">
              * При выборе размеров, параметры цветника расчитываются как
              <br />высота * ширина * толщина
            </p>
          </div>
          ...
          >
            ...
            <div
              :class="[
                'transition-transform duration-300',
                isOpenMaterial ? '-rotate-180' : 'rotate-0',
              ]"
            >
              <Icon
                icon="meteor-icons:chevron-down"
          ...
          <div
            ...
            class="w-full border border-t-0 rounded-b-[8px] px-[34px] pb-[16px]"
          >
            <p class="text-[18px] text-gray01 font-medium">Выберите материал</p>
            <div class="flex gap-[8px] mt-[8px]">
              <div
                class="bg-orange01/[6%] hover:bg-orange01/10 transition-colors duration-300 cursor-pointer rounded-[8px] py-[12px] px-[16px]"
              >
                <span class="text-[18px] text-black01 font-semibold"
                  >Карельский гранит</span
                >
              </div>
              <div
                class="bg-orange01/[6%] hover:bg-orange01/10 transition-colors duration-300 cursor-pointer rounded-[8px] py-[12px] px-[16px]"
